...
public class Client {
    ...
    public static void main(String[] args) {
         ...
         *      Class[]:字节码数组
         *          它是用于让代理对象和被代理对象用相同的方法。固定写法
         *      InvocationHandler:用于提供增强的代码
         *          它是让我们写如何代理，一般都是写一个该接口的实现类，通常情况下都是匿名内部类，但不是必须的
         *          此接口的实现类都是谁用谁写
         */
        IProducer proxyInstance = (IProducer) Proxy.newProxyInstance(Producer.class.getClassLoader(),
                Producer.class.getInterfaces(), new InvocationHandler() {
            /**
